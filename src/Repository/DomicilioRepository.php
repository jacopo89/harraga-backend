...
/**
 * @extends ServiceEntityRepository<Domicilio>
 *
...
class DomicilioRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(Domicilio $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(Domicilio $entity, bool $flush = true): void
    {
