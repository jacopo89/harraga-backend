...
use App\Repository\CompetenzaDigitaleRepository;
use Doctrine\ORM\Mapping as ORM;
use Symfony\Component\Serializer\Annotation\Groups;

/**
 * @ApiResource()
 * @ORM\Entity(repositoryClass=CompetenzaDigitaleRepository::class)
 */
class CompetenzaDigitale
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Competenze::class, inversedBy="competenzaDigitales")
