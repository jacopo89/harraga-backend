...
use App\Repository\LinguaAttestataRepository;
use Doctrine\ORM\Mapping as ORM;
use Symfony\Component\Serializer\Annotation\Groups;

/**
 * @ApiResource()
 * @ORM\Entity(repositoryClass=LinguaAttestataRepository::class)
 */
class LinguaAttestata
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Competenze::class, inversedBy="linguaAttestatas")
