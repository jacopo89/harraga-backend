...
use App\Repository\AssociazioneRepository;
use Doctrine\ORM\Mapping as ORM;
use Symfony\Component\Serializer\Annotation\Groups;

/**
 * @ApiResource()
 * @ORM\Entity(repositoryClass=AssociazioneRepository::class)
 */
class Associazione
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Socialita::class, inversedBy="associaziones")
